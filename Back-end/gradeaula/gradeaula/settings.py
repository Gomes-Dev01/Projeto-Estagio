import os
"""
Django settings for gradeaula project.
...
SECRET_KEY = "django-insecure-a8h!g62&u5(g-ayykq_sabajq*&fgy(pw=8#x8)*160$+#)w8t"
...
WSGI_APPLICATION = "gradeaula.wsgi.application"
